...
function teachpress_admin_settings() {
     ...
     <table class="widefat">
          <thead>
               <tr>
                 ...
                 <td width="210" style="vertical-align: middle;"><?php 
                 ...
                 <td style="vertical-align: middle;"><?php _e('Shows the teachPress database version and available database updates','teachpress'); ?></td>
               </tr>
               <tr>
                    ...
                    <td style="vertical-align: middle;"><?php _e('Here you can change the current term. This value is used for the default settings for all menus.','teachpress'); ?></td>
               </tr>
               <tr>
                 <th><label for="permalink" title="<?php _e('Permalinks','teachpress'); ?>"><?php _e('Permalinks','teachpress'); ?></label></th>
                 <td style="vertical-align:middle;">
                      <select name="permalink" id="permalink" title="<?php _e('Permalinks','teachpress'); ?>">
                      <?php
                      $value = get_tp_option('permalink');
                      if ($value == '1') {
    ...
    echo '<option value="1">' . __('yes','teachpress') . '</option>';
                 ...
                 <td style="vertical-align: middle;"><?php _e('Here you can specify, if your WordPress installation using permalinks or not.','teachpress'); ?></td>   
               </tr>
              <tr>
...
echo '<option value="1">' . __('teachpress_front.css','teachpress') . '</option>';
             ...
             <thead>
              ...
              <td style="vertical-align: middle;"><?php _e('Prevent sign out for your users','teachpress'); ?></td>
              </tr>
              <tr>
	...
	if ($tab == 'courses') { ?>
		...
		<?php } ?>
          ...
          <table class="widefat" style="margin-top:10px;">
               <thead>
                    <tr>
                         ...
                         <td><input name="addstud" type="submit" class="button-secondary" value="<?php _e('Create','teachpress'); ?>"/></td>
                    </tr>
               </thead>
          </table>
          </div>
          ...
          <table class="widefat" style="margin-top:10px;">
               <thead>
                    <tr>
                         ...
                         <td><input name="addsem" type="submit" class="button-secondary" value="<?php _e('Create','teachpress'); ?>"/></td>
                    </tr>
              </thead>
          </table>
          ...
          <table class="widefat" style="margin-top:10px;">
			...
			<td><input name="addtyp" type="submit" class="button-secondary" value="<?php _e('Create','teachpress'); ?>"/></td>
                    </tr>
               </thead>
          </table>
       </div>    
